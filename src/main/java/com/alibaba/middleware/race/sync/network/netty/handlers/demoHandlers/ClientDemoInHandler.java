...
public class ClientDemoInHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        logger.info("com.alibaba.middleware.race.sync.network.netty.handlers.demoHandlers.ClientDemoInHandler.channelRead");
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        logger.info("com.alibaba.middleware.race.sync.network.netty.handlers.demoHandlers.ClientDemoInHandler.channelActive");
